...
text_prompt = "nightclub, party, disco, electric"
...
df = pd.read_csv(csv_file_path, on_bad_lines='error')
...
if embeddings is None or not embeddings:
    ...
    query = "What of the following songs would be better playing on the ambient of the picture described as the following: '"+text_prompt+"'"
    print(query)
    print(songs)
